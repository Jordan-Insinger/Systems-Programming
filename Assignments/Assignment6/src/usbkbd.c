...
static void usb_kbd_led(struct urb *urb)
{
	...
	if (urb->status) {
		...
		spin_lock_irqsave(&kbd->leds_lock, flags);
		{
			num_received = kbd->num_led_received;
			num_acked = kbd->num_led_ack;
		}
		spin_unlock_irqrestore(&kbd->leds_lock, flags);

		printk(KERN_ALERT "(usbkbd led): num received %u, num acknowledged: %u.\n", num_received, num_acked);
...
static int usb_kbd_open(struct input_dev *dev)
{
	...
	/* -------- */
	printk(KERN_ALERT "(usbkbd driver): opened the keyboard device.");
	/* -------- */
...
static void usb_kbd_close(struct input_dev *dev)
{
	...
	/* -------- */
	printk(KERN_ALERT "(usbkbd driver): closed the keyboard device.");
	/* -------- */
...
static void usb_kbd_disconnect(struct usb_interface *intf)
{
	...
	/* -------- */
	printk(KERN_ALERT "(usbkbd driver): disconnecting keyboard device.");
	/* -------- */
